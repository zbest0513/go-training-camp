...
func initApp(fc config.FileConfig) (*pkg.App, error) {
	panic(wire.Build(pkg.ProviderSetPkg, data.ProviderSetData, biz.ProviderSetBiz, service.ProviderSetHandle, router.ProviderSetRouter, data.SqlClientProviderSet))
}
