...
func UUID(v uuid.UUID) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
...
func UUIDEQ(v uuid.UUID) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUUID), v))
	})
}
...
func UUIDNEQ(v uuid.UUID) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
...
func UUIDIn(vs ...uuid.UUID) predicate.Template {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UUIDNotIn(vs ...uuid.UUID) predicate.Template {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UUIDGT(v uuid.UUID) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
...
func UUIDGTE(v uuid.UUID) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
...
func UUIDLT(v uuid.UUID) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
...
func UUIDLTE(v uuid.UUID) predicate.Template {
	return predicate.Template(func(s *sql.Selector) {
