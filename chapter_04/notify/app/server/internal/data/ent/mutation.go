...
const (
	...
	TypeTemplateTagRelation = "TemplateTagRelation"
	TypeUser                = "User"
	TypeUserTagRelation     = "UserTagRelation"
)
...
func (m *TagMutation) SetUUID(s string) {
	m.uuid = &s
}

// UUID returns the value of the "uuid" field in the mutation.
func (m *TagMutation) UUID() (r string, exists bool) {
	v := m.uuid
	if v == nil {
		return
	}
...
// If the Tag object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TagMutation) OldUUID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// SetUUID sets the "uuid" field.
func (m *TemplateMutation) SetUUID(s string) {
	m.uuid = &s
}

// UUID returns the value of the "uuid" field in the mutation.
func (m *TemplateMutation) UUID() (r string, exists bool) {
	v := m.uuid
	if v == nil {
		return
	}
...
// If the Template object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TemplateMutation) OldUUID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldUUID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// TemplateTagRelationMutation represents an operation that mutates the TemplateTagRelation nodes in the graph.
type TemplateTagRelationMutation struct {
	config
	op            Op
	typ           string
	id            *int
...
var _ ent.Mutation = (*TemplateTagRelationMutation)(nil)

// templatetagrelationOption allows management of the mutation configuration using functional options.
type templatetagrelationOption func(*TemplateTagRelationMutation)

// newTemplateTagRelationMutation creates new mutation for the TemplateTagRelation entity.
func newTemplateTagRelationMutation(c config, op Op, opts ...templatetagrelationOption) *TemplateTagRelationMutation {
	m := &TemplateTagRelationMutation{
		config:        c,
		op:            op,
		typ:           TypeTemplateTagRelation,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withTemplateTagRelationID sets the ID field of the mutation.
func withTemplateTagRelationID(id int) templatetagrelationOption {
	return func(m *TemplateTagRelationMutation) {
		var (
			err   error
			once  sync.Once
			value *TemplateTagRelation
		)
		m.oldValue = func(ctx context.Context) (*TemplateTagRelation, error) {
			once.Do(func() {
				if m.done {
					err = fmt.Errorf("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().TemplateTagRelation.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withTemplateTagRelation sets the old TemplateTagRelation of the mutation.
func withTemplateTagRelation(node *TemplateTagRelation) templatetagrelationOption {
	return func(m *TemplateTagRelationMutation) {
		m.oldValue = func(context.Context) (*TemplateTagRelation, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m TemplateTagRelationMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m TemplateTagRelationMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, fmt.Errorf("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *TemplateTagRelationMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// Op returns the operation name.
func (m *TemplateTagRelationMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (TemplateTagRelation).
func (m *TemplateTagRelationMutation) Type() string {
	return m.typ
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *TemplateTagRelationMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *TemplateTagRelationMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *TemplateTagRelationMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *TemplateTagRelationMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TemplateTagRelationMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *TemplateTagRelationMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *TemplateTagRelationMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *TemplateTagRelationMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown TemplateTagRelation unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *TemplateTagRelationMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown TemplateTagRelation edge %s", name)
}
...
// UserTagRelationMutation represents an operation that mutates the UserTagRelation nodes in the graph.
type UserTagRelationMutation struct {
	config
	op            Op
	typ           string
	id            *int
...
var _ ent.Mutation = (*UserTagRelationMutation)(nil)

// usertagrelationOption allows management of the mutation configuration using functional options.
type usertagrelationOption func(*UserTagRelationMutation)

// newUserTagRelationMutation creates new mutation for the UserTagRelation entity.
func newUserTagRelationMutation(c config, op Op, opts ...usertagrelationOption) *UserTagRelationMutation {
	m := &UserTagRelationMutation{
		config:        c,
		op:            op,
		typ:           TypeUserTagRelation,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withUserTagRelationID sets the ID field of the mutation.
func withUserTagRelationID(id int) usertagrelationOption {
	return func(m *UserTagRelationMutation) {
		var (
			err   error
			once  sync.Once
			value *UserTagRelation
		)
		m.oldValue = func(ctx context.Context) (*UserTagRelation, error) {
			once.Do(func() {
				if m.done {
					err = fmt.Errorf("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().UserTagRelation.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withUserTagRelation sets the old UserTagRelation of the mutation.
func withUserTagRelation(node *UserTagRelation) usertagrelationOption {
	return func(m *UserTagRelationMutation) {
		m.oldValue = func(context.Context) (*UserTagRelation, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m UserTagRelationMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m UserTagRelationMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, fmt.Errorf("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *UserTagRelationMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// Op returns the operation name.
func (m *UserTagRelationMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (UserTagRelation).
func (m *UserTagRelationMutation) Type() string {
	return m.typ
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *UserTagRelationMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *UserTagRelationMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *UserTagRelationMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *UserTagRelationMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UserTagRelationMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *UserTagRelationMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *UserTagRelationMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *UserTagRelationMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown UserTagRelation unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *UserTagRelationMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown UserTagRelation edge %s", name)
}
